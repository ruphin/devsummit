        ...
        <Deck progress="pacman" transitionDuration={500}>
          <Slide transition={["zoom"]} bgColor="black" maxWidth={1200}>
            ...
            <div style={{transform: "rotate(-4deg)"}}>
              <Text textSize="2em" margin="0.1em 2.4em 0 0" textAlign="right" textColor="blue" textFont="tertiary">
                by Goffert van Gool
              </Text>
              <Image src={images.swirl.replace("/", "")} width="30%" margin="0 0 0 30%"/>
            </div>
          </Slide>
          ...
          <Slide transition={["slide"]} bgColor="black" maxWidth={1200}>
            <Image src={images.textHtml.replace("/", "")} width="100%" />
          </Slide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [5, 6], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Define the MyElement Class. It must extend HTMLElement</Text>},
              ...
              { loc: [7, 8], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Set some innerHTML</Text>},
              { loc: [11, 12], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Inform the browser about our element</Text> },
              { loc: [0, 13], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/01.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [0, 18], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/02.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [0, 14], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/03.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [0, 4], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/04.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [8, 17], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">But remember: when the constructor runs we are not attached to the DOM</Text>},
              { loc: [8, 17], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">This means you CANNOT use HTMLElement methods for navigating the DOM and manipulating elements or attributes</Text>},
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [12, 15], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Pseudo-selectors work like this</Text>},
              { loc: [15, 18], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Attribute selectors too</Text>},
              { loc: [18, 21], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">You can nest selectors like normal</Text>},
              { loc: [0, 15], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/07.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [16, 22], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Clean up a bit by putting the template attaching in a private method</Text>},
              { loc: [22, 30], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Create a private method to create our cache</Text>},
              { loc: [23, 24], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Set a familiar property to use as a map</Text>},
              { loc: [23, 25], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Loop over all our internal elements</Text>},
              { loc: [23, 29], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">If they have an ID, add them to our map</Text>},
              { loc: [14, 15], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">Now we can easily access stuff</Text>},
              { loc: [0, 15], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/08.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
          ...
          <CodeSlide
            ...
            ranges={[
              ...
              { loc: [17, 18], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">If our property is set, we store the value in an internal variable</Text>},
              { loc: [17, 19], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">We also reflect the state change in other places in our element</Text>},
              { loc: [20, 23], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">The getter is easy, we just return our internal variable</Text>},
              { loc: [14, 15], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white">It still feels like we are just using a property</Text>},
              { loc: [0, 15], note: <Text margin="0" textSize="0.8em" lineHeight={1} textColor="white"><Link textColor="white" href="https://webcomponents.ruph.in/lessons/demo/09.html"><span style={{textDecoration: "underline"}}>Demo</span></Link></Text> },
            ]}></CodeSlide>
